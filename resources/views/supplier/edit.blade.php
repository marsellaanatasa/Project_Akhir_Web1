  ...
  <div class="col-md-6 grid-margin stretch-card mx-auto">
    <div class="card shadow-sm">
      <div class="card-body">
        ...
        <p class="card-description">Ubah data supplier pemasok barang</p>
        ...
        <form class="forms-sample" method="POST" action="{{ route('supplier.update', $supplier->id) }}">
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" name="nama_supplier" class="form-control" id="nama_supplier" value="{{ old('nama_supplier', $supplier->nama_supplier) }}" required>
          </div>
          <div class="form-group mb-3">
            <label for="kontak_person" class="mb-1 fw-bold">Kontak Person</label>
            <input type="text" name="kontak_person" class="form-control" id="kontak_person" value="{{ old('kontak_person', $supplier->kontak_person) }}">
          </div>
          <div class="form-group mb-3">
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" name="telepon" class="form-control" id="telepon" value="{{ old('telepon', $supplier->telepon) }}">
          </div>
          <div class="form-group mb-3">
            <label for="alamat" class="mb-1 fw-bold">Alamat</label>
            <textarea name="alamat" class="form-control" id="alamat" rows="4">{{ old('alamat', $supplier->alamat) }}</textarea>
          </div>
